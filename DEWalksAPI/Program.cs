...
{
    options.SwaggerDoc("v1", new OpenApiInfo{ Title = "DE Walks Api",Version = "v1"});
...
builder.Services.AddIdentityCore<IdentityUser>()
    ...
    .AddTokenProvider<DataProtectorTokenProvider<IdentityUser>>("DEWalks")
    .AddEntityFrameworkStores<DEWalksAuthDbContext>()
